...
public abstract class _mob_preset_dungeons_overgrown_spider extends MOB {
    ...
    public _mob_preset_dungeons_overgrown_spider(final double movementSpeed) {
        ...
        core.instantMoveSelf(0.0f, -0.21875f, 0.0f);
        head.instantMoveSelf(0.0f, 0.0f, 0.0f);
        leg_0b.instantMoveSelf(0.3125f, -0.3125f, 0.0f);
        leg_00.instantMoveSelf(0.59375f, -0.3125f, 0.0f);
        leg_01.instantMoveSelf(1.0f, 0.59375f, 0.0f);
        leg_02.instantMoveSelf(1.265625f, 0.09375f, 0.0f);
        leg_0a.instantMoveSelf(1.0f, 0.59375f, 0.0f);
    }
}
