...
public abstract class _mob_preset_dungeons_overgrown_spider extends MOB {
    ...
    public _mob_preset_dungeons_overgrown_spider() {
        ...
        core.moveSelf(20, 0.0f, -0.40625f, 0.0f);
        head.moveSelf(20, 0.0f, -0.3125f, 0.0f);
        leg_0b.moveSelf(20, 0.0f, -0.5f, 0.0f);
        leg_00.moveSelf(20, -0.53125f, -0.34375f, 0.0f);
        leg_01.moveSelf(20, -0.875f, 0.40625f, 0.0f);
        leg_02.moveSelf(20, -1.140625f, -0.09375f, 0.0f);
        leg_0a.moveSelf(20, -0.875f, 0.40625f, 0.0f);
    }
}
