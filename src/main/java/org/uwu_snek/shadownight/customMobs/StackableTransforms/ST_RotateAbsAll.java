...
public final class ST_RotateAbsAll extends ST {
     ...
     */
    @SuppressWarnings("unused")
    public ST_RotateAbsAll(int duration, @NotNull Function<Double, Double> easing, final @NotNull AxisAngle4f r) {
     ...
     */
    @SuppressWarnings("unused")
    public ST_RotateAbsAll(int duration, @NotNull Function<Double, Double> easing, final @NotNull Quaternionf r) {
    ...
    public static void updateInitial(final @NotNull Bone b, final @NotNull Quaternionf _r) {
        ...
        for(Bone c : b.children) updateChild(c, _r, c.getAbsPos());
