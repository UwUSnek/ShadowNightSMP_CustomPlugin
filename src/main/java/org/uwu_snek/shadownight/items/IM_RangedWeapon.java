...
public abstract class IM_RangedWeapon extends IM {
     ...
     */
    public IM_RangedWeapon(@NotNull String _displayName, @NotNull _custom_item_id _customItemId, @NotNull ATK _attack, double _hitDamage, double _kbMultiplier, double _atkSpeed, double _atkCooldown, boolean _replaceVanillaLInteractions) {
