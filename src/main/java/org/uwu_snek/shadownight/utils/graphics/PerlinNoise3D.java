package org.uwu_snek.shadownight.utils.graphics;
...
public final class PerlinNoise3D  extends UtilityClass implements PerlinNoise {
     ...
     */
    public static double compute(double x, double y, double z, final int gridSize) {
        x /= gridSize;
        y /= gridSize;
        z /= gridSize;
     ...
     *         (x, y).
     */
    public static Vector3i selectGradVector(final int x, final int y, final int z) {
